...
(function (root, factory) {
  ...
  function Regex (opts) {
    ...
    return {
      ...
      parse: (txt, pos) => {
        ...
        let matchedStr = null
        if (result && isInteger(opts.groupIdx) && result[opts.groupIdx + 1]) {
  ...
  parsers.string = Seq(
    {
      ...
      parsers: [
        ...
        Regex({ regex: /^("|#")(.*)(")$/, name: '.body', groupIdx: 1 }),
  ...
  // const strRe1 = /^("|#")(.*)(")$/
  // // const result5 = '"hello"'.match(strRe1)
  // const result5 = '"hel\"lo"'.match(strRe1)
