...
(function (root, factory) {
  ...
  function numSpacesForIndentation (parenDepth, lastOpener) {
    return parenDepth * 2
  }
    ...
    while (idx < numNodes) {
      ...
      if (currentNodeIsNewline) {
        ...
        if (inc(idx) < numNodes) {
          ...
          const topParenStackColIdx = stackPeek(colIdxStack, 0)
          // const numSpaces = parenNestingDepth * 2
          const numSpaces = numSpacesForIndentation(parenNestingDepth, null)
          // const numSpaces = topParenStackColIdx + 2

          // if (topOfTheParenStack) {
          //   console.log('topOfTheParenStack:', topOfTheParenStack)
          //   console.log('topParenStackColIdx:', topParenStackColIdx)
          // }
