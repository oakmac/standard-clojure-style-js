...
(function (root, factory) {
  ...
  function Repeat (opts) {
    return {
      parse: (txt, pos) => {
        ...
        while (lookForTheNextNode && repeatDepth < maxRepeatDepth) {
  ...
  // parsers._form = Choice({ parsers: ['parens'] })
  ...
  // const testRepeat2 = Repeat({
  //   name: 'repeat_test_2',
  //   parsers: [
  //     Char({ name: 'AAA', char: 'a' }),
  //     Regex({ name: 'a bunch of Cs or Ds', regex: /(c|d)+/ }),
  //     Optional(Char({ name: 'ZZZ', char: 'z' }))
  //   ]
  // })

  // const repeatResult1 = testRepeat2.parse('a', 0)
  // console.log(repeatResult1)
  // console.assert(repeatResult1 === null, 'derererere')
