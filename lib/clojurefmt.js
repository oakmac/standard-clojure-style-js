      ...
      if (currentNodeIsNewline) {
        ...
        if (inc(idx) < numNodes) {
          ...
          if (isTokenNode(nextNode)) {
            ...
            // console.log('col index of this next node:', numSpacesOnNextLine)
          }
          ...
          if (topOfTheParenStack && topOfTheParenStack._parenOpenerLineIdx === lineIdx) {
            ...
            while (zzz < numOpeningLineTokens) {
              const openingLineToken = topOfTheParenStack._openingLineTokens[zzz]
              if (openingLineToken._colIdx === numSpacesOnNextLine) {
                // console.log('rule 3 in effect!!!!!', openingLineToken)

                if (isTokenNode(nextNode)) {
                  // console.log('with token:', nextNode)
                }
