...
(function (root, factory) {
  ...
  function format (inputTxt) {
    ...
    while (idx < numNodes) {
      ...
      if (currentNodeIsNewline) {
        ...
        const isCloserFollowedByText = isParenCloser(node) && nextTextNode && (isTokenNode(nextTextNode) || isParenOpener(nextTextNode))
        const addSpaceAfterThisNode = isTokenFollowedByOpener || isCloserFollowedByText
  ...
  // toggle this in order to hit the internal functions with the test suite during development
