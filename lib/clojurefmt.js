...
(function (root, factory) {
  ...
  // TODO: I think we need a walk function that can modify a tree "in place"
  // either that or we should work with the flat map where that operation is easier
  ...
  // NOTES:
  // - would it be easier to work with a flat map of the nodes for adjusting some of this?
  // - seems like some of this would be easier to adjust at the printer level than the node level?

  // applies the "how to ns" rules to a parse tree
  // returns the new tree
  function applyHowToNsRules (tree) {
  ...
  function format (inputTxt) {
    ...
    const treeWithNsRulesApplied = applyHowToNsRules(tree)

    const nodesArr = flattenTree(treeWithNsRulesApplied)
