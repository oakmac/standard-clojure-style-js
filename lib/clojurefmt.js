  ...
  parsers.braces = Seq({
    ...
    parsers: [
      ...
      Choice({
        parsers: [
          Char({ name: '.open', char: '{' }),
          Regex({ name: '.open', regex: /#{/ }), // TODO: there could be a String parser for these
