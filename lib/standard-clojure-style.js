...
(function (root, factory) {
  ...
  function format (inputTxt) {
    ...
    // this is the array index (NOTE: not a node index)
    // for where a single-line comment node might vertically align with nodes above it
    let arrayIndexOfCommentNode = -1
      ...
      if (currentNodeIsNewline) {
        ...
        // if (outputTxtContainsChars) {
          ...
          if (topOfTheParenStack && topOfTheParenStack._rule3Active) {
            ...
            numSpaces = nodeColumnIndexesAfterAdjustment[arrayIndexOfCommentNode]
          } else {
          ...
          // reset the indexes for the location of nodes on the previous line
          // we will build the "afterAdjustment" array as we process upcoming nodes
          // the "beforeAdjustment" array is ready for comparison
