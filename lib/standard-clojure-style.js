    ...
    while (continueParsingNsForm) {
      ...
      if (isParenOpener(node)) {
        ...
        if (insideGenClassImplements && parenNestingDepth < genClassImplementsParenDepth) {
          ...
          genClassToggle = 0 // back to looking for a key
      ...
      } else if (insideGenClass && insideGenClassImplements && idx > genClassNodeIdx &&
    isTokenNode2 && isTextNode && genClassToggle === 1 &&
    genClassKeyStr === 'implements') {
