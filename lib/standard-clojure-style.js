...
(function (root, factory) {
  ...
  function isCommaNode (n) {
    return n.name === 'whitespace' && strEndsWith(n.text, ',')
  }
  ...
  function commentNeedsSpaceBefore (lineTxt, nodeTxt) {
    return strStartsWith(nodeTxt, ';') && lineTxt !== '' && !strEndsWith(lineTxt, ' ')
  }
  ...
  function formatNodes (nodesArr, parsedNs) {
    ...
    while (idx < numNodes) {
      ...
      if (parenStackSize > 0 && !insideNsForm) {
        ...
        // const isNewlineFollowedByComma = isCommentNode(node) && nextTextNode && isNewlineNode(nextTextNode) &&

        //   if (isCommentFollowedByNewline || isNewline) {
        //       console.log('n:', 'xxx' + node.text + 'xxx')
        // console.log('isCommentFollowedByNewline:', isCommentFollowedByNewline)
        ...
        if ((isCommentFollowedByNewline || isNewline) && !isNewlineWithComma) {
          ...
          console.log('n:', 'xxx' + node.text + 'xxx')
          console.log('parenTrailClosers:', parenTrailClosers)
          console.log('+++++++++++++++++++++++++++++++++++++++')
