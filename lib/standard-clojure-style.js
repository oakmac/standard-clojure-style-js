...
(function (root, factory) {
  ...
  function printCommentsAbove (outTxt, commentsAbove, indentationLevel) {
  ...
  function formatRequireLine (req, initialIndentation) {
    ...
    // FIXME: replace with printCommentsAbove
  ...
  function formatNs (ns) {
    ...
    if (hasGenClass) {
      ...
      outTxt = printCommentsAbove(outTxt, ns.genClass.commentsAbove, genClassIndentationLevel)

      outTxt = strConcat(outTxt, repeatString(' ', genClassIndentationLevel))
      ...
      if (ns.genClass.isEmpty) {
        ...
        while (idx3 < numGenClassKeys) {
          ...
          if (genClassValue) {
            ...
            outTxt = printCommentsAbove(outTxt, genClassValue.commentsAbove, genClassValueIndentationLevel)
