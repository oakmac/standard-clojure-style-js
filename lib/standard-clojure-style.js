...
(function (root, factory) {
  ...
  function collectNodeIndexes (nodes, idx) {
    ...
    const initialSpaces = numSpacesAfterNewline(firstNode)
      ...
      if (currentNodeIsNewline) {
        ...
        if (outputTxtContainsChars) {
          ...
          if (nextLineContainsOnlyOneComment) {
            ...
            while (idx2 < numPrevLineNodeIndexes) {
              if (nextLineCommentColIdx === nodeColumnIndexesBeforeAdjustment[idx2]) {
                commentLooksAlignedWithPreviousForm = true
                arrayIndexOfCommentNode = idx2
                // we can exit this loop now
                idx2 = inc(numPrevLineNodeIndexes)
              }
              idx2 = inc(idx2)
            }
          }
          ...
          // NOTES:
          // comments that are outside of a form (ie: paren nesting depth = 0) should
          // not have their indentation adjusted. Unless they are on the next line and are vertically
          // aligned.

          // comments that are inside of a form should have their indentation adjusted as if
          // they were part of the form? this includes 'Rule 3'
