...
(function (root, factory) {
  ...
  function parseNs (nodesArr) {
    ...
    while (continueParsingNsForm) {
      ...
      // merge an end-of-line comment onto the reader comment collected above
      // (from the same line), so the combined text travels with the following
      // require during sorting
      } else if (insideRequireForm && pendingReaderCommentLineNo === lineNo && arraySize(singleLineComments) > 0 && isCommentNode2) {
