...
(function (root, factory) {
  ...
  function formatReferClojure (referClojure) {
    ...
    // there is only :only
      ...
      // const numPlatforms = arraySize(platforms)
      // const symbolsForAllPlatforms = arrayPluck(filterOnPlatform(referClojure.only, false), 'symbol')
      // const numSymbolsForAllPlatforms = arraySize(symbolsForAllPlatforms)

      // // there are no reader conditionals: print all of the symbols
      // if (numPlatforms === 0) {
      //   let s = '\n  (:refer-clojure '
      //   s = strConcat(s, formatKeywordFollowedByListOfSymbols(':only', symbolsForAllPlatforms))
      //   s = strConcat(s, ')')
      //   return s
      ...
      //   while (platformIdx < numPlatforms) {
      //     const platform = platforms[platformIdx]
      //     const symbolsForPlatform = arrayPluck(filterOnPlatform(referClojure.only, platform), 'symbol')
