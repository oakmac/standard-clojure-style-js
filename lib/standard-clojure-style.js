  ...
  function formatNodes (nodesArr, parsedNs) {
    ...
    while (idx < numNodes) {
      ...
      if (currentNodeIsNewline) {
        ...
        // // console.log(lineIdx, arrayLast(nodesWeHavePrintedOnThisLine).text)
        // let xxxxxxx = arrayLast(nodesWeHavePrintedOnThisLine)
        // if (xxxxxxx) {
        //   console.log(lineIdx, xxxxxxx.text)
        //   // if (xxxxxxx.text === ';; ggg') {
        //   //   console.log()
        //   // }
        // } else {
        //   console.log(lineIdx, 'no xxx')
        // }
        // // console.log(lineIdx)

        // console.log('all slurped?', lineIdx, allNextLineNodesWereSlurpedUp)
        // console.log('num spaces:', numSpacesOnNextLine)
        ...
        if (outputTxtContainsChars) {
          ...
          // console.log(lineIdx, 'xxx' + lineTxt + 'xxx', allNextLineNodesWereSlurpedUp)
