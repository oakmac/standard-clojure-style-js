...
(function (root, factory) {
  ...
  function parseNs (nodesArr) {
    ...
    let nsNodeIdx = -1
    let nsSymbolIdx = -1
    let insideNsMetadata = false
    // const nextTokenNodeIsMetadataTrueKey = false
    ...
    while (continueParsingNsForm) {
      ...
      */
      ...
      // collect ns metadata before we hit the nsSymbol
      } else if (!insideNsMetadata && insideNsForm && nsSymbolIdx < 0 && node.name === 'meta') {
        insideNsMetadata = true
