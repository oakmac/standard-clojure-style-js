    ...
    while (idx < numNodes) {
      ...
      if (currentNodeIsNewline) {
        ...
        if (outputTxtContainsChars) {
          ...
          // Comment lines that are outside of a parenStack, but are vertically aligned with a node from
          // the line above them --> align to that node
          } else if (nextLineContainsOnlyOneComment && commentLooksAlignedWithPreviousForm && !topOfTheParenStack) {
